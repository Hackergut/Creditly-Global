...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (!gl) {
        console.warn('WebGL not supported, falling back to background color');
        canvas.style.backgroundColor = '#2c2e43';
        return;
      }
      ...
      // Ottieni location degli uniform
      const uniforms = {
